...
# Address for migration to ElephantSQL
DATABASES = {
    'default': dj_database_url.parse('postgres://pdtejkiv:Dkw1U4ILiBYzZTL3_lJ7S-eyZEKjhXBJ@manny.db.elephantsql.com/pdtejkiv')
}
