...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            # os.path.join(BASE_DIR, 'templates', 'custom_widget_templates'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'pgp_project.wsgi.application'
...
# Amazon AWS settings (when on Heroku)
...
# E-Commerce settings
# default values
# custom values are editable on checkout Admin Settings page
